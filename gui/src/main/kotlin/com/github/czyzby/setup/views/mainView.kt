...
class MainView : ActionContainer {
    ...
    @Inject
    private lateinit var interfaceService: InterfaceService
    @LmlInject
    private lateinit var basicData: BasicProjectData
    @LmlInject
    private lateinit var advancedData: AdvancedData
    @LmlInject
    @Inject
    private lateinit var platformsData: PlatformsData
    @LmlInject
    @Inject
    private lateinit var languagesData: LanguagesData
    @LmlInject
    @Inject
    private lateinit var extensionsData: ExtensionsData
    @LmlInject
    @Inject
    private lateinit var templatesData: TemplatesData
    @LmlActor("form")
    ...
    @LmlAction("platforms")
    fun getPlatforms(): Iterable<*> = platformsData.platforms.keys.sorted()
    @LmlAction("show")
    ...
    fun getLanguages(): Array<String> = languagesData.languages
    @LmlAction("jvmLanguagesVersions")
    fun getLanguagesVersions(): Array<String> = languagesData.versions
    @LmlAction("templates")
    ...
    @LmlAction("thirdPartyExtensionsVersions")
    fun getThirdPartyExtensionsVersions(): Array<String> =
