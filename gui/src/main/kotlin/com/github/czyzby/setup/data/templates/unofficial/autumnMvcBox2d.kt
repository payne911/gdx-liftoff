...
class AutumnMvcBox2dTemplate : AutumnMvcVisTemplate() {
    ...
    override fun addResources(project: Project) {
        ...
        arrayOf("game.lml", "loading.lml", "menu.lml").forEach {
            project.files.add(CopiedFile(projectName = Assets.ID, path = path("ui", "templates", it),
        ...
        arrayOf("controls.lml", "edit.lml", "inactive.lml", "settings.lml", "switch.lml").forEach {
            project.files.add(CopiedFile(projectName = Assets.ID, path = path("ui", "templates", "dialogs", it),
                    original = path("generator", "templates", "autumn", "box2d", "dialogs", it)))
        }
        project.files.add(CopiedFile(projectName = Assets.ID, path = path("ui", "templates", "macros", "global.lml"),
...
public class Configuration {
	...
	public void initiateConfiguration(final SkinService skinService) {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.configuration.preferences",
                fileName = "ControlsData.java", content = """package ${project.basic.rootPackage}.configuration.preferences;
...
public class ControlsData {
	...
	public ControlsData(final ControlType type) {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.configuration.preferences",
                fileName = "ControlsPreference.java", content = """package ${project.basic.rootPackage}.configuration.preferences;
...
public class ControlsPreference extends AbstractPreference<Array<ControlsData>> {
	...
	protected String serialize(final Array<ControlsData> preference) {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.controller",
                fileName = "GameController.java", content = """package ${project.basic.rootPackage}.controller;
...
public class Global implements ActionContainer {
	...
	public int getPlayersAmount() {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.controller.dialog",
                fileName = "ControlsController.java", content = """package ${project.basic.rootPackage}.controller.dialog;
...
public class ControlsController implements ActionContainer, ViewDialogShower {
	...
	public void switchControls(final Actor actor) {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.controller.dialog",
                fileName = "ControlsEditController.java", content = """package ${project.basic.rootPackage}.controller.dialog;
...
public class ControlsEditController implements ActionContainer, ViewDialogShower {
	...
	private class MockUpdateAction extends Action {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.controller.dialog",
                fileName = "ControlsSwitchController.java", content = """package ${project.basic.rootPackage}.controller.dialog;
...
public class ControlsSwitchController implements ActionContainer, ViewDialogShower {
	...
	private void changeControls(final Control control) {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.controller.dialog",
                fileName = "NotEnoughPlayersErrorController.java", content = """package ${project.basic.rootPackage}.controller.dialog;
...
public class SettingsController implements ActionContainer {
	...
	public void setWindowedMode() {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.entity",
                fileName = "Player.java", content = """package ${project.basic.rootPackage}.entity;
...
public class Player implements ControlListener {
	...
	public void jump() {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.service",
                fileName = "Box2DService.java", content = """package ${project.basic.rootPackage}.service;
...
public class Box2DService {
	...
	public void dispose() {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.service",
                fileName = "ControlsService.java", content = """package ${project.basic.rootPackage}.service;
...
public class ControlsService {
	...
	public Array<Control> getControls() {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.service",
                fileName = "FullscreenService.java", content = """package ${project.basic.rootPackage}.service;
...
public abstract class AbstractButtonControl extends AbstractControl {
	...
	public void setJump(final int jump) {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.service.controls",
                fileName = "AbstractControl.java", content = """package ${project.basic.rootPackage}.service.controls;
...
public enum ControlType {
	...
	public abstract Control create(ControlsData data);
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.service.controls.impl",
                fileName = "GamePadControl.java", content = """package ${project.basic.rootPackage}.service.controls.impl;
...
public class GamePadControl extends AbstractButtonControl {
	...
	public ControlType getType() {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.service.controls.impl",
                fileName = "InactiveControl.java", content = """package ${project.basic.rootPackage}.service.controls.impl;
...
public class InactiveControl implements Control {
	...
	public void reset() {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.service.controls.impl",
                fileName = "KeyboardControl.java", content = """package ${project.basic.rootPackage}.service.controls.impl;
...
public class KeyboardControl extends AbstractButtonControl {
	...
	public ControlType getType() {
        ...
        project.files.add(SourceFile(projectName = Core.ID, packageName = "${project.basic.rootPackage}.service.controls.impl",
                fileName = "TouchControl.java", content = """package ${project.basic.rootPackage}.service.controls.impl;
