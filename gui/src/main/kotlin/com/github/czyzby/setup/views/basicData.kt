...
class BasicProjectData {
    @LmlActor("name")
    private lateinit var nameField: VisTextField
    @LmlActor("package")
    private lateinit var rootPackageField: VisTextField
    @LmlActor("class")
    private lateinit var mainClassField: VisTextField
    @LmlActor("destination")
    private lateinit var destinationField: VisTextField
    @LmlActor("androidSdk")
    private lateinit var androidSdkPathField: VisValidatableTextField

    @LmlActor("mkdirs")
    private lateinit var mkdirsButton: Button
    @LmlActor("clearFolder")
    private lateinit var clearButton: Button

    @LmlActor("useOldestSdk", "useLatestSdk")
    private lateinit var sdkButtons: ObjectSet<Button>
