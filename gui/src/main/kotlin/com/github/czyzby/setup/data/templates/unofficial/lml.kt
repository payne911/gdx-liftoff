...
import com.github.czyzby.setup.data.libs.unofficial.LML
...
class LmlTemplate : Template {
    ...
    override fun apply(project: Project) {
        ...
        project.files.add(SourceFile(projectName = Assets.ID, sourceFolderPath = "ui", packageName = "templates",
                fileName = "main.lml", content = """<!-- Note: you can get content assist thanks to DTD schema files. See the official LML page. -->
